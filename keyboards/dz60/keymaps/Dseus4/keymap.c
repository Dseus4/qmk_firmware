...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_all(
        ...
        KC_LCTL,    TD(TD_FUNCS),KC_LALT,                           KC_SPC,     KC_SPC,     KC_SPC,                             KC_RGUI,    KC_LEFT,    KC_DOWN,    KC_RGHT,    KC_RCTL
    ),
    [_NUM] = LAYOUT_all(
        ...
        _______,    _______,    _______,    _______,    KC_CALC,    _______,    _______,    _______,    KC_P0,      KC_PDOT,    KC_PENT,    KC_PSLS,    _______,    _______,    _______,
    ...
    [_SYSTEM] = LAYOUT_all(
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    NK_ON,      NK_OFF,     _______,    _______,
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,
        _______,    RGB_TOG,    RGB_HUI,    RGB_SAI,    RGB_VAI,    BL_STEP,    _______,    _______,    _______,    _______,    _______,    _______,    KC_VOLU,    _______,    _______,
        _______,    _______,    _______,                            KC_MPLY,    KC_MPLY,    KC_MPLY,                            _______,    KC_MPRV,    KC_VOLD,    KC_MNXT,    _______
    ),
    [_SPEC] = LAYOUT_all(
        KC_GRV,     _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,     KC_DEL,    
        _______,    DM_REC1,    DM_PLY1,    _______,    _______,    _______,    _______,    _______,    KC_INS,     _______,    KC_PSCR,    _______,    _______,    _______,
        _______,    DM_REC2,    DM_PLY2,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    DM_RSTP,
